var canvas = document.getElementById("the-canvas"),
    ...
    score,
	apple = new Image();
    apple.src = 'images/monster.png',
    audio = new Audio('audio/audio.mp3');
    audio2 = new Audio('audio/pluk.mp3');
...
function paint() {
    ...
    if (snakeHeadX === -1 || snakeHeadX === canvas.width / cellSize ||
        ...
        document.body.innerHTML = 'МИШО , LOVE YOU <3 !!! ' + '<br>' + '<img src="images/gay.jpg">' + '<img src="images/gay3.jpg">' + '<img src="images/gay2.jpg">';
